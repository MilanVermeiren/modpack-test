...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        add(ModBlocks.BLACK_OPAL_ORE.get(),
                (block) -> createOreDrop(ModBlocks.BLACK_OPAL_ORE.get(), ModItems.RAW_BLAKC_OPAL.get()));
        add(ModBlocks.DEEPSLATE_BLACK_OPAL_BLOCK_ORE.get(),
                (block) -> createOreDrop(ModBlocks.DEEPSLATE_BLACK_OPAL_BLOCK_ORE.get(), ModItems.RAW_BLAKC_OPAL.get()));
        add(ModBlocks.NETHERRACK_BLACK_OPAL_BLOCK_ORE.get(),
