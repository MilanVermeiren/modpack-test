package net.elmo.ElmosMod.block;

import net.elmo.ElmosMod.ElmosMod;
import net.elmo.ElmosMod.block.custom.ModFLammableRotatedPillarBlock;
import net.elmo.ElmosMod.item.ModItems;
import net.elmo.ElmosMod.worldgen.tree.EbonyTreeGrower;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, ElmosMod.MOD_ID);
    ...
    public static final RegistryObject<Block> DEEPSLATE_BLACK_OPAL_BLOCK_ORE = registerBlock("deepslate_black_opal_ore",
            ()->new  DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(8f).requiresCorrectToolForDrops(), UniformInt.of(2,6)));
    public static final RegistryObject<Block> NETHERRACK_BLACK_OPAL_BLOCK_ORE = registerBlock("netherrack_black_opal_ore",
            ()->new  DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(4f).requiresCorrectToolForDrops(), UniformInt.of(2,6)));
    public static final RegistryObject<Block> ENDSTONE_BLACK_OPAL_BLOCK_ORE = registerBlock("endstone_black_opal_ore",
            ()->new  DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
